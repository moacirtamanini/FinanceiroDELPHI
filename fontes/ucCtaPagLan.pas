...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        MessageDlg('O valor da primeira parcela é maior que o valor total', mtWarning, [mbOk], 0);
        Exit;
      end;
    end;
  end;
  ...
  begin
    MessageDlg('A categoria de despesas não foi informada', mtWarning, [mbOk], 0);
    Exit;
  end;

  if (frame_CategoriaSai.Codigo < 1) then
  begin
    MessageDlg('A categoria pagadora não foi informada', mtWarning, [mbOk], 0);
    Exit;
  end;
